	...
	return (
		<div className="flex items-center justify-center py-6 sm:py-8 md:py-9 lg:py-10 xl:py-10">
			<div className="w-full max-w-xl rounded-2xl border border-border bg-default p-6 text-center shadow-sm sm:p-8 md:p-9 lg:p-10 xl:p-10">
				<h1 className="text-2xl  text-ink sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl">Thank you!</h1>
				<p className="mt-3 text-sm text-ink sm:mt-4 sm:text-base md:text-lg lg:text-lg xl:text-lg md:leading-[25px] leading-[20px] sm:leading-[30px]">
