				...
				<div className="relative rounded-2xl overflow-hidden">
					...
					<div className="absolute bg-white/20 h-500 backdrop-blur-md bottom-6 left-6 right-6  text-white p-6 rounded-xl">
						...
						<div className="space-y-4 text-sm font-light leading-relaxed text-primary-foreground sm:space-y-5 sm:text-base md:text-lg lg:text-xl lg:leading-snug">
							<p>
								At Prime Bank, we believe in building lasting relationships with our customers. Our
								multi-channel support approach ensures you can reach us through your preferred
								communication method, whether that's phone, email, in-person at our branches, or through
								our digital platforms.
							</p>
							<p>
								We're available 24/7 for emergencies and during business hours for general inquiries.
								Your satisfaction is our priority, and we won't rest until your issue is resolved.
							</p>
						</div>
			...
			<div className="container mx-auto grid md:grid-cols-2 gap-6 mt-8">
				<div className="rounded-2xl border border-tartiary bg-white p-6 shadow-sm">
					...
					<p className="text-sm text-gray-600">
						Simpletree Anarkali <br /> Holding No: 89, Plot No: 03, Block: CWS(A)
						<br />
