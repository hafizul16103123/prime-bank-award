import { Student, StudentStatus } from "@/app/api/modules/student/models/Student";
...
export async function GET(request: AuthenticatedRequest) {
  try {
    ...
    let query: any = { school: userSchool,status:{$in: [StudentStatus.APPROVED, StudentStatus.AWARDED]} };
